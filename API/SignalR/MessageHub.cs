...
namespace API.SignalR
{
    ...
    public class MessageHub : Hub
    {
        ...
        public async Task SendMessage(CreateMessageDto createMessageDto)
        {
             ...
             if(userName == createMessageDto.RecipientUsername.ToLower()) throw new HubException("You can't send messsages to yourself");
             ...
             {
                messgae.DateRead = DateTime.UtcNow;
             }else
             {
             ...
             {
                await Clients.Group(groupName).SendAsync("NewMessage", _mapper.Map<MessageDto>(messgae));
             }
        }
        ...
        private async Task<Group> AddToGroup(string groupName)
        {
           ...
           throw new HubException("Failed to add in group");
        }
